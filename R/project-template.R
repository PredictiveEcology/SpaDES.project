...
setMethod(
  ...
  definition = function(name, path, type, open = interactive()) {
    ...
    if (type == "basic") {
      ...
      projectTemplates[[2]] <- readLines(file.path(.pkgEnv[["templatePath"]], "LandR_fS-00-global.R.template"))
      projectTemplates[[3]] <- readLines(file.path(.pkgEnv[["templatePath"]], "LandR_fS-01-init.R.template"))
      projectTemplates[[4]] <- readLines(file.path(.pkgEnv[["templatePath"]], "LandR_fS-02-paths.R.template"))
      projectTemplates[[5]] <- readLines(file.path(.pkgEnv[["templatePath"]], "LandR_fS-03-packages.R.template"))
      projectTemplates[[6]] <- readLines(file.path(.pkgEnv[["templatePath"]], "LandR_fS-04-options.R.template"))
      projectTemplates[[7]] <- readLines(file.path(.pkgEnv[["templatePath"]], "LandR_fS-05-google-ids.R.template"))
      projectTemplates[[8]] <- readLines(file.path(.pkgEnv[["templatePath"]], "LandR_fS-06-studyArea.R.template"))
      projectTemplates[[9]] <- readLines(file.path(.pkgEnv[["templatePath"]], "LandR_fS-07a-dataPrep_2001.R.template"))
      projectTemplates[[10]] <- readLines(file.path(.pkgEnv[["templatePath"]], "LandR_fS-07b-dataPrep_2011.R.template"))
      projectTemplates[[11]] <- readLines(file.path(.pkgEnv[["templatePath"]], "LandR_fS-07c-dataPrep_fS.R.template"))
      projectTemplates[[12]] <- readLines(file.path(.pkgEnv[["templatePath"]], "LandR_fS-08a-ignitionFit.R.template"))
      projectTemplates[[13]] <- readLines(file.path(.pkgEnv[["templatePath"]], "LandR_fS-08b-escapeFit.R.template"))
      projectTemplates[[14]] <- readLines(file.path(.pkgEnv[["templatePath"]], "LandR_fS-08c-spreadFit.R.template"))
      projectTemplates[[15]] <- readLines(file.path(.pkgEnv[["templatePath"]], "LandR_fS-09-main-sim.R.template"))
