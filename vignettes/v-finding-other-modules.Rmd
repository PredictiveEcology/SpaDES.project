...
mods <- listModules(grepListShort, accounts = Account)
# The fireSense_Size* modules are no longer used
mods$PredictiveEcology <- grep("Size", value = TRUE, invert = TRUE, mods$PredictiveEcology)
...
# The fireSense_Size* modules are no longer used
modsLong$PredictiveEcology <- grep("Size", value = TRUE, invert = TRUE, 
                                   modsLong$PredictiveEcology)
