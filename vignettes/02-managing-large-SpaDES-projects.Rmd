...
We don't want project libraries interefereing with other projects, or our user's default package library, so it's best to use a standalone package library.
...
Using `config` is opitonal though, as thes can be defined in `02-init.R`.
