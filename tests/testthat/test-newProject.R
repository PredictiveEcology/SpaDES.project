...
test_that("newProject (advanced) creates necessary files", {
  ...
  expect_true(file.exists(file.path(myProjDir, "02-packages.R")))
  expect_true(file.exists(file.path(myProjDir, "03-paths.R")))
  expect_true(file.exists(file.path(myProjDir, "04-options.R")))
  expect_true(file.exists(file.path(myProjDir, "05-objects.R")))
